                    ...
                    <div className="w-full md:w-1/2 p-8">
                        ...
                        <form onSubmit={handleSignUp} className='mt-4'>
                            <div className="mb-4">
                                ...
                                <input name='name' className="shadow appearance-none border rounded-full w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="full name" />
                            </div>
